...
export default function LoadingCategory(props) {
  return (
    <div className="row-span-2 w-full animate-pulse h-28 bg-my_green/70 border-2 border-my_soft_black/70 text-my_soft_cream/70 text-lg rounded-md text flex flex-col gap-4 justify-center items-center p-3">
