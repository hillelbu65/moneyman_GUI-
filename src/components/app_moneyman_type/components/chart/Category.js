...
export default function Category(props) {
  ...
  return (
    <div className="row-span-2 w-full h-36 bg-my_green border-2 border-my_soft_black text-my_soft_cream text-lg rounded-md text flex flex-col gap-4 justify-center items-center p-3">
